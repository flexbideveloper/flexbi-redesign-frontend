...
export var barChartData: any[] = [
  { barPercentage: 0.5, data: [13, 8, 20, 4, 18, 29, 25], label: 'Google' },
  { barPercentage: 0.5, data: [31, 20, 6, 16, 21, 4, 11], label: 'Facebook' },
];

export var barChartColors: Array<any> = [
  {
    backgroundColor: '#21cead',
  },
  {
...
// Pie
export var pieChartLabels: string[] = [
  'Africa',
  'Asia',
  'Europe',
  'Latin America',
...
export var pieChartColors: any[] = [
  { backgroundColor: ['#21cead', '#212529', '#17a00e', '#f41127', '#ffc107'] },
];
...
export var radarChartLabels: any[] = [
  'Africa',
  'Asia',
  'Europe',
  'Latin America',
...
// Polor
export var polorChartLabels: string[] = [
  'Lable1',
  'Lable2',
  'Lable3',
  'Lable4',
...
export var polorChartColors: any[] = [
  {
    backgroundColor: ['#21cead', '#212529', '#17a00e', '#f41127', '#ffc107'],
...
export var horizontalbarChartLabels: string[] = [
  'Africa',
  'Asia',
  'Europe',
  'Latin America',
